...
const Hero: React.FC<HeroProps> = ({ name, specialty, description, socialLinks }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      <div className="w-full lg:w-1/2 rounded-xl bg-white dark:bg-gray-800 p-6">
        ...
        <div className="grid grid-cols-3 gap-2 mt-4">
          <Link 
            ...
            target="_blank" 
            className="bg-gray-100 dark:bg-gray-700 rounded-xl p-3 flex items-center justify-center hover:scale-105 transition-all duration-300"
          >
        ...
        <div className="flex gap-2 mt-4">
          ...
          <Link
            href="/projects"
            className="flex-1 bg-gray-100 dark:bg-gray-700 rounded-lg px-4 py-3 flex items-center justify-center font-medium hover:scale-105 transition-all duration-300 text-gray-900 dark:text-white text-sm"
          >
            View My Work
          </Link>
        </div>
      ...
      <div className="w-full lg:w-1/2">
        <div className="h-[400px] rounded-xl bg-white dark:bg-gray-800 overflow-hidden">

...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 px-2 md:px-12 lg:px-50 xl:px-60">
        ...
        <div
          ...
          >
            <ul className="font-medium flex flex-col p-3 md:p-0 mt-2 md:mt-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:border-0 bg-gray-50 bg-opacity-90 md:bg-transparent dark:bg-gray-800 dark:bg-opacity-90 md:dark:bg-transparent dark:border-gray-700">
              ...
              <li>
                <Link href="/projectView" passHref className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-300 md:hover:bg-transparent md:border-0 md:hover:text-blue-900 md:p-0 dark:text-white md:dark:hover:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" onClick={closeMenu}>
                  Projects
                </Link>
              </li>
              <li>

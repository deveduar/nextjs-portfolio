...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <Link 
      ...
      className="group w-full border border-gray-200/50 dark:border-gray-800 rounded-xl overflow-hidden cursor-pointer transition-all hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700 flex flex-col h-64
    ...
    >
      <div className="relative h-28 w-full overflow-hidden flex-shrink-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 bg-white dark:bg-gray-900">
          <h3 className="font-semibold text-slate-900 dark:text-white text-sm line-clamp-1">{title}</h3>
        </div>
      </div>
      
      <div className="p-3 bg-white dark:bg-gray-900 flex flex-col flex-1">
